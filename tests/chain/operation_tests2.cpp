...
{ try {
   ...
   BOOST_TEST_MESSAGE( "=== withdraw_permission_create ===" );
...
{ try {
   ...
   BOOST_TEST_MESSAGE( "=== withdraw_permission_test ===" );
...
{ try {
   ...
   BOOST_TEST_MESSAGE( "=== withdraw_permission_nominal_case ===" );
...
{ try {
   ...
   BOOST_TEST_MESSAGE( "=== withdraw_permission_update ===" );
...
{ try {
   ...
   BOOST_TEST_MESSAGE( "=== withdraw_permission_delete ===" );
...
{ try {
   ...
   }
   {
      ...
      BOOST_CHECK_EQUAL((int)obj.feeds.size(), 3);
...
{ try {
   ...
   BOOST_TEST_MESSAGE( "=== feed_limit_test ===" );
...
{ try {
   ...
   BOOST_TEST_MESSAGE( "=== witness_create ===" );
...
BOOST_AUTO_TEST_CASE( global_settle_test )
{
   try {
      ...
      BOOST_TEST_MESSAGE( "=== global_settle_test ===" );
...
{ try {
   ...
   BOOST_TEST_MESSAGE( "=== worker_create_test ===" );
...
{ try {
   ...
   BOOST_TEST_MESSAGE( "=== worker_pay_test ===" );
...
{try{
   ...
   BOOST_TEST_MESSAGE( "=== refund_worker_test ===" );
...
{try{
   ...
   BOOST_TEST_MESSAGE( "=== burn_worker_test ===" );
...
BOOST_AUTO_TEST_CASE( force_settle_test )
{
   try
   {
      ...
      BOOST_TEST_MESSAGE( "=== force_settle_test ===" );
...
BOOST_AUTO_TEST_CASE( assert_op_test )
{
   try {
      ...
      BOOST_TEST_MESSAGE( "=== assert_op_test ===" );
...
{ try {
   ...
   BOOST_TEST_MESSAGE( "=== balance_object_test ===" );
...
BOOST_AUTO_TEST_CASE(transfer_with_memo) {
   try {
      ...
      BOOST_TEST_MESSAGE( "=== transfer_with_memo ===" );
...
BOOST_AUTO_TEST_CASE(zero_second_vbo)
{
   try
   {
      ...
      BOOST_TEST_MESSAGE( "=== zero_second_vbo ===" );
