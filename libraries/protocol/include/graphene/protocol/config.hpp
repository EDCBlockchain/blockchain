...
#define GRAPHENE_ADDRESS_PREFIX "EDC"
...
#define GRAPHENE_MAX_SHARE_SUPPLY int64_t(999999999999999000)
...
#define GRAPHENE_MAX_BLOCK_INTERVAL  5 /* seconds */
...
#define GRAPHENE_DEFAULT_TRANSFER_FEE                           (0*GRAPHENE_BLOCKCHAIN_PRECISION)
...
#define GRAPHENE_DEFAULT_NETWORK_PERCENT_OF_FEE               (100*GRAPHENE_1_PERCENT)
#define GRAPHENE_DEFAULT_LIFETIME_REFERRER_PERCENT_OF_FEE     (0*GRAPHENE_1_PERCENT)
#define GRAPHENE_DEFAULT_MAX_BULK_DISCOUNT_PERCENT            (0*GRAPHENE_1_PERCENT)
...
#define GRAPHENE_DEFAULT_BURN_PERCENT_OF_FEE                  (0*GRAPHENE_1_PERCENT)
...
// alpha account
#define ALPHA_ACCOUNT_ID (graphene::protocol::account_id_type(18))
// CORE asset id
#define CORE_ASSET (graphene::protocol::asset_id_type(0))
// EDC asset id
#define EDC_ASSET (graphene::protocol::asset_id_type(1))
// edc symbol
